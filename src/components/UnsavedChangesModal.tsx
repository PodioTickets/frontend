...
export type UnsavedChangesModalProps = {
  ...
  title?: string;
  description?: string;
  /** Se definido, exibe botão principal “Salvar alterações” antes das demais ações. */
...
export function UnsavedChangesModal({
  ...
  description = "Você fez alterações nesta página. Se sair agora, elas serão perdidas.",
  onSaveAndLeave,
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      await Promise.resolve(onSaveAndLeave());
    } finally {
      setSaving(false);
    }
  };
