...
export function SuspendEventModal({
  open,
  onClose,
  event: eventInfo,
  onConfirm,
              ...
              <div className="flex flex-col items-center justify-center px-5 pt-6 pb-5 gap-8">
                <div className="flex flex-col gap-4 items-center justify-center w-full">
                  ...
                  <p className="font-normal text-sm leading-[1.3] text-gray-11 font-family-dm-sans text-center">
                    Ao suspender este evento, as inscrições ficam indisponíveis,
                    porém você continuará com acesso total ao painel de controle
                    para gerenciar os participantes já inscritos e realizar
                ...
                <div className="flex gap-2 items-stretch w-full">
                  ...
                  >
                    {loading ? "Suspendo..." : "Suspender evento"}
                  </Button>
                </div>
              </div>
            </motion.div>
