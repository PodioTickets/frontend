export function EmailIcon({ className }: { className?: string }) {
  return (
    <svg width="19" height="17" viewBox="0 0 19 17" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path d="M4.08333 4.91667L7.23433 7.01733C8.354 7.76378 9.81267 7.76378 10.9323 7.01733L14.0833 4.91667M4.08333 15.75H14.0833C15.9243 15.75 17.4167 14.2576 17.4167 12.4167V4.08333C17.4167 2.24238 15.9243 0.75 14.0833 0.75H4.08333C2.24238 0.75 0.75 2.24238 0.75 4.08333V12.4167C0.75 14.2576 2.24238 15.75 4.08333 15.75Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}