      ...
      <div className="mx-auto max-w-7xl px-5 py-[52px] pb-[176px]">
        <div className="flex flex-col items-center gap-9 w-full">
          ...
          <div className="flex w-full max-w-[1280px] flex-col items-start gap-[52px] px-0 lg:px-0">
            <div className="flex w-full flex-col gap-8 md:flex-row md:items-start">
              <div className="w-full min-w-0 md:flex-1">
                <div className="relative h-[404px] w-full overflow-hidden rounded-2xl shadow-[0px_8px_16px_0px_rgba(17,17,17,0.5)] md:h-[400px]">
                  <ImageWithInitialFallback src={bannerUrl} alt={eventName} name={eventName} fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 75vw, 66vw" className="size-full rounded-2xl border-transparent border-0" letterClassName="text-7xl font-bold" />
                </div>
              </div>
              {eventTyped && (
            ...
            {eventTyped && <div className="w-full md:hidden"><EventPublicInfoCardMobile event={eventTyped} isPreview /></div>}
